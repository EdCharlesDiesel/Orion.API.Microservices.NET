...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.1.7'));
 ...
 */
new project_tsconfig_paths.Version('20.1.7');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.1.7` usually means that core is at head so it supports
