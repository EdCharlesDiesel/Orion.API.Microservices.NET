...
[TestSubject(typeof(ExternalEmployeesController))]
public class ExternalEmployeesControllerTest
{
    // private readonly Mock<IUnitOfWork> _mockUnitOfWork;
    // private readonly Mock<IEmployeeRepository> _mockRepo;
    // private readonly ExternalEmployeesController _controller;
    //
    // public ExternalEmployeesControllerTest()
    // {
    //     _mockUnitOfWork = new Mock<IUnitOfWork>();
    //     _mockRepo = new Mock<IEmployeeRepository>();
    //
    //     // Mock Departments repository
    //     _mockUnitOfWork.Setup(u => u.Ex).Returns(_mockRepo.Object);
    //
    //     _controller = new ExternalEmployeesController(_mockUnitOfWork.Object);
    // }
    //
    // [Fact(Skip = "Failing")]
