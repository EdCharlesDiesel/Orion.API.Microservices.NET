...
public class EarningsController : ControllerBase
{
      ...
      /// <summary>
        ...
        {
            return await Orion.Services.StockAnalyzer.API.Helper.HttpRequesterClass.HttpRequester("/earnings");
        }
        ...
        {
            return await Orion.Services.StockAnalyzer.API.Helper.HttpRequesterClass.HttpRequester($"/earnings?d1={startDate.Value.ToString("yyyy-MM-dd")}");
        }
        ...
        public static async Task<string> GetEarningsByMarketDate(string symbol, DateTime? startDate = null)
        {
            ...
            return await Orion.Services.StockAnalyzer.API.Helper.HttpRequesterClass.HttpRequester($"/earnings/symbol/{symbol}?d1={startDate.Value.ToString("yyyy-MM-dd")}");
        }
        ...
        public static async Task<string> GetEarningsMarketBetweenDates(string symbol, DateTime? startDate = null, DateTime? endDate = null)
        {
            ...
            return await Orion.Services.StockAnalyzer.API.Helper.HttpRequesterClass.HttpRequester($"/earnings/symbol/{symbol}?d1={startDate.Value.ToString("yyyy-MM-dd")}&d2={endDate.Value.ToString("yyyy-MM-dd")}");
        }
        ...
        public static async Task<string> GetEarningsByCountry(string country)
        {
            ...
            return await Orion.Services.StockAnalyzer.API.Helper.HttpRequesterClass.HttpRequester($"/earnings/country/{country}");
        }
        ...
        public static async Task<string> GetEarningsByType(string type)
        {
            ...
            return await Orion.Services.StockAnalyzer.API.Helper.HttpRequesterClass.HttpRequester($"/earnings?type={type}");
        }
}