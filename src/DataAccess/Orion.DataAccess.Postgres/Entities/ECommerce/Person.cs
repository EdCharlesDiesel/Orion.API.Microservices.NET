...
namespace Orion.DataAccess.Postgres.Entities.ECommerce
{
    ...
    public class Person
    {
        public Person()
        {
            ...
            this.PersonPhones = new List<Entities.PersonPhone>();
            this.Customers = new List<Customer>();
            this.PersonCreditCards = new List<Entities.PersonCreditCard>();
        }
        ...
        public IEnumerable<Entities.PersonPhone> PersonPhones { get; set; }
        ...
        public IEnumerable<Entities.PersonCreditCard> PersonCreditCards { get; set; }
    }
}
