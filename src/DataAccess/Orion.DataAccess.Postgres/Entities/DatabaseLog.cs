...
namespace Orion.DataAccess.Postgres.Entities
{
    ...
    public class DatabaseLog
    {
        ...
        [Column(name : "DatabaseUser", TypeName = "nvarchar")]
        [MaxLength(128)]
        [StringLength(128)]
        ...
        [Column(name : "Event", TypeName = "nvarchar")]
        [MaxLength(128)]
        [StringLength(128)]
