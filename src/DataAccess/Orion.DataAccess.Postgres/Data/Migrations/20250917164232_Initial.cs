        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HumanResources.EmployeeDepartmentHistory_Employee_BusinessE~",
                        column: x => x.BusinessEntityID,
                        principalSchema: "HumanResources",
                        principalTable: "Employee",
                        principalColumn: "BusinessEntityID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HumanResources.EmployeePayHistory_Employee_BusinessEntityID",
                        column: x => x.BusinessEntityID,
                        principalSchema: "HumanResources",
                        principalTable: "Employee",
                        principalColumn: "BusinessEntityID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HumanResources.JobCandidate_Employee_BusinessEntityID",
                        column: x => x.BusinessEntityID,
                        principalSchema: "HumanResources",
                        principalTable: "Employee",
                        principalColumn: "BusinessEntityID");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Billing", new Guid("68a51bec-dd71-408f-b68a-76cca0cbfe73") },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Home", new Guid("308de43c-8cee-4c18-a2af-84419d197257") },
                    { 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Main Office", new Guid("c79d0a5e-bcbc-4846-86f0-1f1d912bfb57") },
                    { 4, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Primary", new Guid("0fe672a4-2913-4049-9b30-df7ea337a85d") },
                    { 5, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Shipping", new Guid("eb9d9d9b-868c-495f-8a31-f1d9fdb61490") },
                    { 6, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Archive", new Guid("0c2a8111-60ea-4de4-9c89-32c12cbf88b9") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new Guid("bd1da44c-c6b3-4ce0-86eb-89bc54c24ff5") });
            ...
            migrationBuilder.InsertData(
                schema: "HumanResources",
                table: "Employee",
                columns: new[] { "BusinessEntityID", "BirthDate", "EntityVersion", "Gender", "HireDate", "Id", "JobLevel", "JobTitle", "LoginID", "MaritalStatus", "MinimumRaiseGiven", "ModifiedDate", "NationalIDNumber", "Salary", "SickLeaveHours", "SuggestedBonus", "VacationHours", "YearsInService", "rowguid" },
                values: new object[] { 1, new DateTime(9999, 12, 31, 23, 59, 59, 999, DateTimeKind.Unspecified).AddTicks(9999), 2147483647, "M", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000000"), 8, "Developer", "Batman", "M", true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "8898086267098", 20000000, (short)21, 120000000, (short)199, 10, new Guid("8424e352-667f-4c36-9126-99142fc58336") });

            migrationBuilder.InsertData(
                schema: "Person",
                table: "Person",
                columns: new[] { "BusinessEntityID", "AdditionalContactInfo", "Demographics", "EmailPromotion", "FirstName", "LastName", "MiddleName", "ModifiedDate", "PersonType", "Suffix", "Title", "rowguid" },
                values: new object[] { 4, "Ckhotso@gmail.com", "", 1, "Khotso", "Mokhethi", "Ed", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "E", "ADMIN", "Mr", new Guid("d2bb7ab6-60ab-4ec2-ab9b-beb6bbca723a") });
